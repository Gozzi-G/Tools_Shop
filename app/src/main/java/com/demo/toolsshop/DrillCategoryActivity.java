...
public class DrillCategoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Создаем массив дрелей и добавляем каждую создаваю новый объект
        ...
        //Связываем массив дрелей с нашим ListView с помощью Adapter
        ...
        //Используем слушатель событий чтобы при клики на элемент вызывалась детализация
        // о подробной информации инструмента
        listViewDrills.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                //передаем позицию выбранного элемента из массива дрелей в переменную "drill"
                ...
                intent.putExtra("imageResourceId", drill.getImageResourceId());
